...
def Login():
    ...
    clearButton = Button(tlogin, text="Clear", width=12, command=lambda: clearBoxes(form, userEntry, passEntry))
    clearButton.grid(row=3, column=1, padx=10, pady=10)

    enterButton = Button(tlogin, text="Enter", width=12, command=lambda: get_login(form, userEntry, passEntry))
